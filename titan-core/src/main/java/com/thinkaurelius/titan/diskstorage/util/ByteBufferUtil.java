...
public class  ByteBufferUtil {
	...
	/*
	 * Could be more efficient if it didn't create a copy of the array
	 */
    public static String bytesToHex(ByteBuffer byteBuffer) {
		return new String(Hex.encodeHex(Arrays.copyOfRange(byteBuffer.array(), byteBuffer.position(), 
