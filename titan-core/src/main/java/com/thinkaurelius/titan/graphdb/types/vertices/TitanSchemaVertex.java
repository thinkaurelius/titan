        ...
        if (name == null) {
            ...
            if (isLoaded()) {
                ...
                p = (TitanProperty) Iterables.getOnlyElement(RelationConstructor.readRelation(this,
                        tx.getGraph().getSchemaCache().getSchemaRelations(getLongId(), BaseKey.SchemaName, Direction.OUT),
                        tx), null);
            } else {
        ...
        if (def == null) {
            ...
            if (isLoaded()) {
                ...
                ps = (Iterable)RelationConstructor.readRelation(this,
                        tx.getGraph().getSchemaCache().getSchemaRelations(getLongId(), BaseKey.SchemaDefinitionProperty, Direction.OUT),
                        tx);
            } else {
        ...
        if (rels==null) {
            ...
            if (isLoaded()) {
                ...
                edges = (Iterable)RelationConstructor.readRelation(this,
                        tx.getGraph().getSchemaCache().getSchemaRelations(getLongId(), BaseLabel.SchemaDefinitionEdge, dir),
                        tx);
            } else {
