...
public class GeoshapeTest {
    ...
    public void testIntersection() {
        for (int i=0;i<50;i++) {
            ...
            Geoshape line = Geoshape.line(i-1,i-1,i,i,i+1,i+1);
            Geoshape polygon = Geoshape.polygon(i-1,i-1,i,i-1,i+1,i-i,i+1,i+1,i-1,i+1,i-1,i-1);
    ...
    public void testEquality() {
        ...
        Geoshape l = Geoshape.line(10.5,20.5,10.5,22.5,12.5,22.5);
        Geoshape p = Geoshape.polygon(10.5,20.5,8.0,21.75,10.5,22.5,11.75,25.0,12.5,22.5,15.0,21.0,12.5,20.5,11.75,18.0,10.5,20.5);
        assertEquals(Geoshape.circle(10.0,12.5,100),c);
        assertEquals(Geoshape.box(20.0,22.5,40.5,60.5),b);
        assertEquals(Geoshape.line(10.5,20.5,10.5,22.5,12.5,22.5),l);
        assertEquals(Geoshape.polygon(10.5,20.5,8.0,21.75,10.5,22.5,11.75,25.0,12.5,22.5,15.0,21.0,12.5,20.5,11.75,18.0,10.5,20.5),p);
        ...
        assertEquals(Geoshape.line(10.5,20.5,10.5,22.5,12.5,22.5).hashCode(),l.hashCode());
        assertEquals(Geoshape.polygon(10.5,20.5,8.0,21.75,10.5,22.5,11.75,25.0,12.5,22.5,15.0,21.0,12.5,20.5,11.75,18.0,10.5,20.5).hashCode(),p.hashCode());
    ...
    public void testGeoJsonLine() throws IOException {
        ...
        Map json = new ObjectMapper().readValue("{\n" +
                ...
                "  }\n" +
                "}", HashMap.class);
         assertEquals(Geoshape.line(10.5,20.5,10.5,22.5,12.5,22.5), s.convert(json));
    }
    ...
    public void testGeoJsonPolygon() throws IOException {
        ...
        Map json = new ObjectMapper().readValue("{\n" +
                ...
                "  }" +
                "}", HashMap.class);
        assertEquals(Geoshape.polygon(10.5,20.5,8.0,21.75,10.5,22.5,11.75,25.0,12.5,22.5,15.0,21.0,12.5,20.5,11.75,18.0,10.5,20.5), s.convert(json));
    }
    ...
    public void testGeoJsonMultiPoint() throws IOException {
        ...
        Map json = new ObjectMapper().readValue("{\n" +
                ...
                "  }" +
                "}", HashMap.class);
        assertEquals(Geoshape.geoshape(gf.createMultiPoint(new Coordinate[] {new Coordinate(100,0), new Coordinate(101,1)})), s.convert(json));
    }
    ...
    public void testGeoJsonMultiLineString() throws IOException {
        ...
        Map json = new ObjectMapper().readValue("{\n" +
                ...
                "  }" +
                "}", HashMap.class);
        assertEquals(Geoshape.geoshape(gf.createMultiLineString(new LineString[] {
    ...
    public void testGeoJsonMultiPolygon() throws IOException {
        ...
        Map json = new ObjectMapper().readValue("{\n" +
                ...
                "  }" +
                "}", HashMap.class);
        assertEquals(Geoshape.geoshape(gf.createMultiPolygon(new Polygon[] {
    ...
    public void testGeoJsonSerialization() throws IOException {
        ...
        assertEquals("{\"type\":\"LineString\",\"coordinates\":[[20.5,10.5],[22.5,10.5],[22.5,12.5]]}", om.writeValueAsString(Geoshape.line(10.5,20.5,10.5,22.5,12.5,22.5)));
        assertEquals("{\"type\":\"Polygon\",\"coordinates\":[[[20.5,10.5],[21.75,8],[22.5,10.5],[25,11.75],[22.5,12.5],[21,15],[20.5,12.5],[18,11.75],[20.5,10.5]]]}",
                om.writeValueAsString(Geoshape.polygon(10.5,20.5,8.0,21.75,10.5,22.5,11.75,25.0,12.5,22.5,15.0,21.0,12.5,20.5,11.75,18.0,10.5,20.5)));
        assertEquals("{\"type\":\"MultiPoint\",\"coordinates\":[[100,0],[101,1]]}",
                om.writeValueAsString(Geoshape.geoshape(Geoshape.CTX.makeShape(gf.createMultiPoint(new Coordinate[] {new Coordinate(100,0), new Coordinate(101,1)})))));
        assertEquals("{\"type\":\"MultiLineString\",\"coordinates\":[[[100,0],[101,1]],[[102,2],[103,3]]]}",
                om.writeValueAsString(Geoshape.geoshape(Geoshape.CTX.makeShape(gf.createMultiLineString(new LineString[] {
                        gf.createLineString(new Coordinate[] {new Coordinate(100,0), new Coordinate(101,1)}),
        ...
        assertEquals("{\"type\":\"MultiPolygon\",\"coordinates\":[[[[102,2],[103,2],[103,3],[102,3],[102,2]]],[[[100,0],[101,0],[101,1],[100,1],[100,0]],[[100.2,0.2],[100.8,0.2],[100.8,0.8],[100.2,0.8],[100.2,0.2]]]]}",
                om.writeValueAsString(Geoshape.geoshape(Geoshape.CTX.makeShape(gf.createMultiPolygon(new Polygon[] {
                        gf.createPolygon(new Coordinate[] {new Coordinate(102,2), new Coordinate(103,2), new Coordinate(103,3), new Coordinate(102,3), new Coordinate(102,2)}),
                        gf.createPolygon(gf.createLinearRing(new Coordinate[] {new Coordinate(100,0), new Coordinate(101,0), new Coordinate(101,1), new Coordinate(100,1), new Coordinate(100,0)}),
