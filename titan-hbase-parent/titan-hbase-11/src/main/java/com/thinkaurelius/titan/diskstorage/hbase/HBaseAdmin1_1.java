...
public class HBaseAdmin1_1 implements AdminMask
{

    private static final Logger log = LoggerFactory.getLogger(HBaseAdmin1_1.class);

    private final Admin adm;

    public HBaseAdmin1_1(HBaseAdmin adm)
    {
        this.adm = adm;
    }
    @Override
